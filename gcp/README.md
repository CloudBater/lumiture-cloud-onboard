...
>
> **The customer-facing public version is [`CloudMile-Product/lumiture-cloud-onboard`](https://github.com/CloudMile-Product/lumiture-cloud-onboard) (`gcp/`)** — prod-only, clean, no internal references. Keep customer-facing changes flowing there; this repo is for internal use (multi-env testing, dev/staging/sandbox runs).
...
- **Public client repo:** `CloudMile-Product/lumiture-cloud-onboard` (`gcp/`, prod-only — what customers run via the Cloud Shell badge).
